...
AUTO_RESPOND_BUTTON_ACTIVE_TEXT = "response is active";
AUTO_RESPOND_BUTTON_SCRIPT_TEXT = "response is script";
AUTO_RESPOND_BUTTON_DELETE_TEXT = "Delete";
AUTO_RESPOND_BUTTON_FLOOD_TEXT = "Flooding";
AUTO_RESPOND_LABEL_FLOOD_TEXT = "Text to Flood in the channel";
...
AUTO_RESPOND_OPTIONS_BUTTON_ACTIVEMOD = "Mod Active/Not Active";
AUTO_RESPOND_OPTIONS_BUTTON_INFIGHT = "Respond with busy message while in combat";
